 ...
 *   使用：只需在xml文件中使用{@code <com.gary.garytool.view.viewpager.PhotoCarouselWithViewPager/>} ，
 ...
 * </pre>
 */
public class PhotoCarouselWithViewPager extends LinearLayout{
    /**
     * 上下文
     */
     ...
     * @param context
     */
    public PhotoCarouselWithViewPager(Context context) {
        this(context,null);
    }

    public PhotoCarouselWithViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    ...
    public void setImageResources(ArrayList<String> imageUrlList, ImageCycleViewListener imageCycleViewListener) {
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            if (i == 0) {
                mImageViews[i].setBackgroundResource(R.drawable.view_ad_cycle_view_banner_dian_focus);
            } else {
                mImageViews[i].setBackgroundResource(R.drawable.view_ad_cycle_view_banner_dian_blur);
            }
    ...
    private final class GuidePageChangeListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            // 设置图片滚动指示器背景
            mImageViews[index].setBackgroundResource(R.drawable.view_ad_cycle_view_banner_dian_focus);
